...
| `isCrossTenant`                         | `bool`   | No       | Optional. Indicates if the module is used in a cross tenant scenario. If true, a delegatedManagedIdentityResourceId must be included in roleAssignments.                                                                                                                      |
